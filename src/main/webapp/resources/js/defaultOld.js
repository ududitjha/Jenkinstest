...
function VerifyOtp()
{
    ...
    var urll = baseUrl + "/openam/login/verifyCode?realm=users&service=" + cookie + "&browserID=" + browserId;
...
function resendCode(type)
{
    ...
    $.ajax({
        url:baseUrl + "/openam/login/resend?realm=users&service=" +cookie + "&userName=" + userName + "&currentCase=" + currentCase + "&type=" + type +"&browserID=" + browserId,
        type:"POST",
        success:function(result, status, xhr){
...
function removeDevice(deviceId){
    ...
    $.ajax({
        url:baseUrl + "/openam/SecurityView/removeDevice?deviceId="+deviceId+"&userName=" + userName +"&realm=users&service=Accounts&browserID=" + browserId  + "&sessionId=" + sessionId,
        type:"GET",
        success: function(result,status,xhr) {
...
function removeAllDevices(){
    ...
    var  sessionId = LoadFromLocalStorage("sessionId");
    $.ajax({
        url:baseUrl + "/openam/SecurityView/removeAllDevices?userName=" + userName +"&realm=users&service=Accounts&browserID=" + browserId + "&sessionId=" + sessionId,
        type:"GET",
        success: function(result,status,xhr) {
...
function logout()
{
    ...
    //     url:baseUrl + "/openam/identity/logout?userName=" + userName +"&realm=users&service=Accounts&browserID=" + browserId + "&tokenID=" + getCookie("tokenId"),
    ...
    $.ajax({//SaveInLocalStorage("tokenId", data.tokenID);
        url:baseUrl + "/openam/login/logout?userName=" + userName +"&realm=users&service=Accounts&browserID=" + browserId + "&tokenID=" + tokenId,
        type:"GET",
        success: function(result,status,xhr) {
            console.log(result);
            //            return;
